...
export const PRODUCTS: SeedProduct[] = [
  { name: 'Meridian Sit-Stand Desk 1600', sku: 'WS-1600-OAK', category: 'Workstations', supplier: 'Kestrel Timber Works', description: 'Electric height-adjustable desk, 1600×800mm, oak veneer top.', unit: 'unit', purchasePrice: 412, sellingPrice: 749, stockQuantity: 34, minStockLevel: 10 },
  { name: 'Meridian Sit-Stand Desk 1400', sku: 'WS-1400-OAK', category: 'Workstations', supplier: 'Kestrel Timber Works', description: 'Electric height-adjustable desk, 1400×800mm, oak veneer top.', unit: 'unit', purchasePrice: 378, sellingPrice: 689, stockQuantity: 41, minStockLevel: 10 },
  { name: 'Halden Bench Desk 4-Person', sku: 'WS-BEN-4P', category: 'Workstations', supplier: 'Kestrel Timber Works', description: 'Four-person back-to-back bench with shared cable tray.', unit: 'unit', purchasePrice: 960, sellingPrice: 1685, stockQuantity: 8, minStockLevel: 4 },
  { name: 'Corner Workstation 1800', sku: 'WS-CNR-1800', category: 'Workstations', description: 'Fixed-height corner desk with modesty panel.', unit: 'unit', purchasePrice: 246, sellingPrice: 445, stockQuantity: 6, minStockLevel: 8 },
  { name: 'Vertex Ergo Task Chair', sku: 'ST-ERGO-BLK', category: 'Seating', supplier: 'Vertex Seating', description: 'Mesh-back task chair, 4D arms, 10-year frame warranty.', unit: 'unit', purchasePrice: 218, sellingPrice: 399, stockQuantity: 62, minStockLevel: 20 },
  { name: 'Vertex Ergo Task Chair (Headrest)', sku: 'ST-ERGO-HR', category: 'Seating', supplier: 'Vertex Seating', description: 'Ergo task chair with adjustable headrest.', unit: 'unit', purchasePrice: 254, sellingPrice: 459, stockQuantity: 28, minStockLevel: 12 },
  { name: 'Draughtsman Stool', sku: 'ST-DRFT-GRY', category: 'Seating', supplier: 'Vertex Seating', description: 'Height-adjustable stool with footring, grey fabric.', unit: 'unit', purchasePrice: 132, sellingPrice: 249, stockQuantity: 3, minStockLevel: 6 },
  { name: 'Alcove Soft Seating Two-Seat', sku: 'ST-SOFT-2S', category: 'Seating', description: 'High-back two-seat booth in wool-blend upholstery.', unit: 'unit', purchasePrice: 640, sellingPrice: 1150, stockQuantity: 5, minStockLevel: 3 },
  { name: 'Mobile Pedestal 3-Drawer', sku: 'SG-PED-3D', category: 'Storage', supplier: 'Cobalt Metal Fabrication', description: 'Lockable steel pedestal on castors.', unit: 'unit', purchasePrice: 88, sellingPrice: 165, stockQuantity: 74, minStockLevel: 25 },
  { name: 'Personal Locker Bank of 6', sku: 'SG-LOCK-6', category: 'Storage', supplier: 'Cobalt Metal Fabrication', description: 'Six-door locker bank with digital locks.', unit: 'unit', purchasePrice: 470, sellingPrice: 845, stockQuantity: 11, minStockLevel: 5 },
  { name: 'Open Shelving Unit 1800', sku: 'SG-SHLF-1800', category: 'Storage', description: 'Five-tier open shelving, powder-coated steel.', unit: 'unit', purchasePrice: 156, sellingPrice: 289, stockQuantity: 19, minStockLevel: 8 },
  { name: 'Acoustic Desk Screen 1400', sku: 'AC-SCR-1400', category: 'Acoustics', supplier: 'Halcyon Acoustics', description: 'PET felt desk-mounted screen, 1400×400mm.', unit: 'unit', purchasePrice: 62, sellingPrice: 119, stockQuantity: 88, minStockLevel: 30 },
  { name: 'Acoustic Wall Panel 600×600', sku: 'AC-PNL-600', category: 'Acoustics', supplier: 'Halcyon Acoustics', description: 'Class A absorber panel, 40mm, concealed fixings.', unit: 'unit', purchasePrice: 44, sellingPrice: 84, stockQuantity: 210, minStockLevel: 60 },
  { name: 'Acoustic Ceiling Baffle', sku: 'AC-BAF-1200', category: 'Acoustics', supplier: 'Halcyon Acoustics', description: 'Suspended vertical baffle, 1200×300mm.', unit: 'unit', purchasePrice: 58, sellingPrice: 108, stockQuantity: 24, minStockLevel: 30 },
  { name: 'Phone Booth Single', sku: 'AC-BOOTH-1P', category: 'Acoustics', description: 'Single-occupancy acoustic pod with ventilation and lighting.', unit: 'unit', purchasePrice: 3150, sellingPrice: 5290, stockQuantity: 2, minStockLevel: 2 },
  { name: 'Desktop Power Module 2×Socket', sku: 'PD-PWR-2S', category: 'Power & data', supplier: 'Meridian Electrical Supply', description: 'Clamp-on module with two sockets and two USB-C.', unit: 'unit', purchasePrice: 41, sellingPrice: 79, stockQuantity: 130, minStockLevel: 40 },
  { name: 'Vertical Cable Spine', sku: 'PD-CBL-SPN', category: 'Power & data', supplier: 'Meridian Electrical Supply', description: 'Flexible spine routing cables from desk to floor box.', unit: 'unit', purchasePrice: 22, sellingPrice: 45, stockQuantity: 96, minStockLevel: 30 },
  { name: 'Under-Desk Cable Tray 1200', sku: 'PD-TRY-1200', category: 'Power & data', description: 'Perforated steel cable tray with fixings.', unit: 'unit', purchasePrice: 17, sellingPrice: 34, stockQuantity: 145, minStockLevel: 50 },
